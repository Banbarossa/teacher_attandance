                          ...
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                                    ...
                                    Hello {{ucFirst(Auth::user()->name)}}
                                      <div class="dropdown d-inline">
                                        ...
                                        <ul class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#changePassword"> Ubah Password</a>
                                          </li>
                              ...
                              <div>
                                <form action="{{route('logout')}}" method="post">
                                  @csrf
                                  <button type="submit" class="btn btn-warning px-5">Log out</button>
                                </form>
                              </div>
      ...
      <form action="{{route('profile.update')}}" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" aria-describedby="helpId" placeholder="Nama" value="{{auth()->user()->name}}">
             @error('name')
         ...
         <div class="mb-3">
            ...
            <input type="mail" class="form-control @error('email') is-invalid @enderror" nama="email" id="email" aria-describedby="helpId" placeholder="email" value="{{auth()->user()->email}}" disabled>
             @error('email')
             <div class="invalid-feedback">
                {{$message}}
             </div>
         ...
         <div class="mb-3">
            ...
            <select name="roler" id="role" class="form-select" disabled>
               <option value="">Pilih Role</option>
               <option value="admin" {{auth()->user()->role == 'admin' ?'selected' : ''}}>admin</option>
               <option value="piket" {{auth()->user()->role == 'piket' ?'selected' : ''}}>Petugast Piket</option>
      ...
      <form action="{{route('profile.update')}}" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control @error('old_password') is-invalid @enderror" nama="old_password" id="old_password" aria-describedby="helpId" placeholder="Password lama" value="">
             @error('old_password')
             <div class="invalid-feedback">
                {{$message}}
             </div>
         ...
         <hr class="hr-horizontal">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control @error('password') is-invalid @enderror" nama="password" id="password" aria-describedby="helpId" placeholder="Password" value="">
             @error('password')
             <div class="invalid-feedback">
                {{$message}}
             </div>
         ...
         <div class="mb-3">
            ...
            <input type="text" class="form-control @error('password_confirmation') is-invalid @enderror" nama="password_confirmation" id="password_confirmation" aria-describedby="helpId" placeholder="Password Confirmation" value="">
