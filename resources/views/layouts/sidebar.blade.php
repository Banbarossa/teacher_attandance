            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('report.harian')? 'active' :'' }} "
                    ...
                    <ul class="sub-nav" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('report.summary')? 'active' :'' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('report.bulanan')? 'active' :'' }}"
                ...
                @can('isAdmin')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->Is('rombel*') ? 'active' :'' }}"
